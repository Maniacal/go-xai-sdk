...
const file_xai_api_v1_chat_proto_rawDesc = "" +
	"\n" +
	"\x15xai/api/v1/chat.proto\x12\axai_api\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19xai/api/v1/deferred.proto\x1a\x16xai/api/v1/image.proto\x1a\x17xai/api/v1/sample.proto\x1a\x16xai/api/v1/usage.proto\"\xe0\a\n" +
	...
	"R\x11parallelToolCalls\x88\x01\x01B\x04\n" +
	"\x02_nB\r\n" +
	"\v_max_tokensB\a\n" +
	"\x05_seedB\x0e\n" +
	"\f_temperatureB\b\n" +
	...
	"\x14_parallel_tool_callsJ\x04\b\x04\x10\x05\"\x9d\x02\n" +
	"\x19GetChatCompletionResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12)\n" +
	"\achoices\x18\x02 \x03(\v2\x0f.xai_api.ChoiceR\achoices\x124\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12.\n" +
	"\achoices\x18\x02 \x03(\v2\x14.xai_api.ChoiceChunkR\achoices\x124\n" +
	...
	"\tcitations\x18\a \x03(\tR\tcitations\"\xa2\x01\n" +
	...
	"\blogprobs\x18\x04 \x01(\v2\x11.xai_api.LogProbsR\blogprobs\"\xb6\x01\n" +
	...
	"\n" +
	"tool_calls\x18\x03 \x03(\v2\x11.xai_api.ToolCallR\ttoolCalls\"\xb4\x01\n" +
	"\vChoiceChunk\x12$\n" +
	...
	"\x04role\x18\x02 \x01(\x0e2\x14.xai_api.MessageRoleR\x04role\x120\n" +
	"\n" +
	"tool_calls\x18\x03 \x03(\v2\x11.xai_api.ToolCallR\ttoolCalls\"6\n" +
	"\bLogProbs\x12*\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x18\n" +
	"\alogprob\x18\x02 \x01(\x02R\alogprob\x12\x14\n" +
	"\x05bytes\x18\x03 \x01(\fR\x05bytes\"c\n" +
	"\aContent\x12\x14\n" +
	"\x04text\x18\x01 \x01(\tH\x00R\x04text\x127\n" +
	"\timage_url\x18\x02 \x01(\v2\x18.xai_api.ImageUrlContentH\x00R\bimageUrlB\t\n" +
	"\acontent\"\xed\x01\n" +
	"\aMessage\x12*\n" +
	...
	"\n" +
	"tool_calls\x18\x04 \x03(\v2\x11.xai_api.ToolCallR\ttoolCallsB\x14\n" +
	...
	"\vtool_choice\"?\n" +
	"\x04Tool\x12/\n" +
	"\bfunction\x18\x01 \x01(\v2\x11.xai_api.FunctionH\x00R\bfunctionB\x06\n" +
	"\x04tool\"x\n" +
	"\bFunction\x12\x12\n" +
	...
	"\x15GetDeferredCompletion\x12\x1b.xai_api.GetDeferredRequest\x1a&.xai_api.GetDeferredCompletionResponse\"\x00B1Z/github.com/Maniacal/go-xai-sdk/proto/xai/api/v1b\x06proto3"
